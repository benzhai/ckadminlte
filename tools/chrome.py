...
def chrome_login(chromeOpitons, home, url, cookie):
    browser = webdriver.Chrome(executable_path = 'chromedriver', chrome_options=chromeOpitons)
    browser.get(home)
...
for cookie in cookies:
    t = threading.Thread(target=chrome_login,args=(chromeOpitons, home, rurl, cookie,))
    t.start()
...
chrome_login(chromeOpitons, home, rurl, cookie)
